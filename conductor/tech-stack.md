...
## Core Development
- **Networking & Orchestration**: **Go** (Standard Library, `colly` for scraping, `obfs4` for obfuscation, `utls` for protocol mimicry, `yaml.v3` for config). Responsible for 100% of network I/O, concurrent scraping, and the SOCKS5 server/tunneling layer.
